...
pub trait StringsAdapter: sealed::StringsAdapter {}

impl StringsAdapter for bytestring::ByteString {}
impl StringsAdapter for String {}

impl sealed::StringsAdapter for bytestring::ByteString {
    fn replace_with_str_checked_bytes(&mut self, b: Bytes) {
        *self = unsafe { Self::from_bytes_unchecked(b) }
    }
    fn len(&self) -> usize {
    ...
    where
        B: BufMut,
    {
        buf.put(Bytes::clone(self.as_bytes()));
    }
}
...
pub mod string {
        ...
        A: StringsAdapter,
    {
        ...
        match std::str::from_utf8(&bytes) {
            ...
            Err(_err) => Err(DecodeError::new(
                "invalid string value: data is not UTF-8 encoded",
            )),
        }
    }

    length_delimited!(impl StringsAdapter);
...
mod sealed {
    ...
    pub trait StringsAdapter: Default + Sized + 'static {
        fn len(&self) -> usize;
        ...
        fn replace_with_str_checked_bytes(&mut self, b: bytes::Bytes);
    }
}
